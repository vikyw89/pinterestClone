        ...
        <div className="self-center flex items-center justify-center p-10 max-w-5xl rounded-box bg-neutral text-neutral-content w-full">
          <div className="flex flex-col w-full">
            ...
            <div className="flex flex-wrap">
              <div className="flex flex-col max-w-lg w-full bg-neutral text-neutral-content">
                <div className="flex-1 h-full relative">
                  ...
                  {pin.image_url === '' &&
                    <>
                      <div
                        className='aspect-square flex flex-col items-center justify-center relative border-opacity-50 border-neutral-content border-4 border-dashed'>
                        <CloudUploadIcon />
                        <div>
                          click to upload
                        </div>
              ...
              <div
                id="createPinInput"
                className="text-base-content flex flex-col justify-between flex-1">
                <input
                  id="pinTitle"
                  value={pin.title}
                  onChange={pinHandler}
                ...
                <textarea
                  ...
                  className="input input-bordered w-full bg-neutral-focus text-neutral-content break-words placeholder:break-words" />
                <input
                  id="pinLink"
                  value={pin.link}
                  onChange={pinHandler}
